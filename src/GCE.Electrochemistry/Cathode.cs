...
/// <summary>
/// Represents a cathodic electrode where reduction reactions are the primary
/// electrochemical process.
/// </summary>
/// <remarks>
/// The primary kinetics are modelled by a <see cref="ButlerVolmerModel"/>.
/// Additional reactions (e.g. a secondary cathodic process such as HER alongside ORR)
/// can be registered via <see cref="AddReaction"/>.
/// The total current density is the sum of all reactions.
/// </remarks>
public sealed class Cathode : IElectrode
{
    ...
    /// <summary>
    /// Gets the open-circuit (equilibrium) potential of this cathode (V vs. SHE).
    /// Equal to the material's standard potential.
    /// </summary>
    public double OpenCircuitPotential => Material.StandardPotential;

    /// <summary>Gets the additional reactions registered on this cathode.</summary>
    public IReadOnlyList<IElectrochemicalReaction> AdditionalReactions => _additionalReactions;

    /// <param name="material">The material this cathode is made from.</param>
    ...
    /// </exception>
    public Cathode(IMaterial material, double area, IEnvironment environment, double alpha = 0.5)
    {
    ...
    /// <summary>
    /// Registers an additional electrochemical reaction on this cathode.
    /// </summary>
    ...
    /// Sums the primary Butler–Volmer reduction current and all additional reaction currents.
    /// </summary>
